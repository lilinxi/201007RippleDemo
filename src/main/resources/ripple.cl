//---
// http://media.pragprog.com/titles/pb7con/code/DataParallelism/Ripple/src/main/resources/ripple.cl
...
__kernel void ripple(__global float* vertices,
  ...
  for (int i = 0; i < num_centers; ++i) {
    if (times[i] != 0) {
      ...
      // Solution: (float)()
      z += AMPLITUDE *
        exp((float)(-DECAY_RATE * r * r)) *
        exp((float)(-WAVE_PACKET * delta * delta)) *
        cos((float)(FREQUENCY * M_PI_F * delta));
    }
  }
